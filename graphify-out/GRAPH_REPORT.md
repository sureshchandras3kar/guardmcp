# Graph Report - guardmcp  (2026-06-29)

## Corpus Check
- 166 files · ~85,270 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2078 nodes · 4419 edges · 143 communities (129 shown, 14 thin omitted)
- Extraction: 82% EXTRACTED · 18% INFERRED · 0% AMBIGUOUS · INFERRED: 816 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b0ce52e5`
...
Cohesion: 0.19
Nodes (5): Policy, _pipeline_with(), TestApiVersion, TestPerCollectionMask, TestTemporal

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (36): neutralize(), #6: backend-neutral success accessors.      Map a backend-native success `data`, EvalResult, Return executor for the active connection (or default)., Run policy + risk check. Does NOT execute or audit.          `trace` (optional):, #1 seam: capability-native entry point.          Maps a Capability → a represent, Deny if the policy has a temporal window and now is outside it., C1/C2 guard for aggregation pipelines. Returns a DENIED Decision if the (+28 more)

### Community 3 - "Community 3"
Cohesion: 0.20
Nodes (13): Context, Action, FastMCP, FastMCP, ToolContext, _elicit_confirm(), Ask human for in-band yes/no via MCP elicitation. Returns True if confirmed., _run_with_confirm() (+5 more)

### Community 4 - "Community 4"
Cohesion: 0.17
Nodes (18): guardmcp_capabilities — backend + per-collection permitted-action discovery., register(), GuardPipeline, FastMCP, ToolContext, _active_backend_info(), _active_plugin(), _active_supported_caps() (+10 more)
...
Cohesion: 0.06
Nodes (45): ApprovalStore, Deterministic assertion engine for GuardMCP evals.  Checks actual pipeline outpu, main(), guardmcp eval — CLI entry point.  Usage:     python -m guardmcp.eval evals/cases, Seed mongomock-motor databases from fixture declarations., seed(), discover(), _load_file() (+37 more)

### Community 10 - "Community 10"
Cohesion: 0.10
Nodes (26): current_traceparent(), _format(), get_trace_id(), log_event(), new_span_id(), new_trace_id(), parse_traceparent(), Dependency-free structured logging + trace-id correlation.  Replaces ad-hoc `pri (+18 more)
...
Cohesion: 0.16
Nodes (15): test_approval_required_then_approved(), DecisionStatus, Request, ActionPolicy, ApprovalPolicy, Path, Action, _policy() (+7 more)
...
Cohesion: 0.12
Nodes (14): MongoPlugin, Backend safety validation. Re-raises tool-layer ToolError as         GuardValida, Estimate the cost of a find/aggregate via explain(executionStats),         norma, Action, CapabilityRequest, CapabilityResult, CostEstimate, test_cross_resource_refs_extracts_lookup_and_unionwith() (+6 more)

### Community 20 - "Community 20"
Cohesion: 0.15
Nodes (22): Reusable conformance checks for GuardMCP DatabasePlugin implementations.  Third-, Enum, Capability, CapabilityRequest, CapabilityResult, CostLevel, Query cost estimation — the FROZEN, backend-neutral public contract.  A plugin e, GuardError (+14 more)

### Community 21 - "Community 21"
Cohesion: 0.12
Nodes (20): AuditLogger, Drain the queue, stop the flusher, flush+close the handle (R-2)., Single writer: batch all queued records into one write + one fsync., Return the _hmac of the last record on disk, or genesis if none., AuditRecord, Path, _expected_hmac(), Tests for the tamper-evident audit log (HMAC chain, restart seeding, fail-closed (+12 more)
...
Cohesion: 0.13
Nodes (30): ArgumentParser, _build_parser(), _builtin_registry(), _check_h1(), _cmd_audit_verify(), _cmd_capability_inspect(), _cmd_config_validate(), _cmd_doctor() (+22 more)
...
Cohesion: 0.18
Nodes (3): MongoClient, MongoClient, MongoExecutor

### Community 43 - "Community 43"
Cohesion: 0.12
Nodes (17): ApprovalStore, Remove resolved approvals older than max_age_seconds. Returns count pruned., AuditLogger, GuardPipeline, CR-2: switching the active connection is a security-relevant control         act, _Loader, _StubRegistry, PolicyEngine (+9 more)
...
Cohesion: 0.25
Nodes (15): _call(), _get_tool(), _make_client(), Tests for the MCP tool-design overhaul: dual names, envelopes, plan, capabilitie, Register real tools into a FastMCP and fetch the callable for `name`., _register_into_fake(), rw_pipeline(), test_annotations_applied_or_skipped() (+7 more)

### Community 47 - "Community 47"
Cohesion: 0.19
Nodes (14): Tamper-evident audit log (per-process HMAC chain).  Risk #5 — multi-writer attri, datetime, Eval runner: builds an isolated GuardPipeline per eval case and runs it.  Uses m, ErrorCode, Canonical machine-readable error codes.      This is a CORE concept: policy/pipe, Governance-state seams (Risk #4).  These are the seams for distributed backends, Action, AuditRecord (+6 more)
...
Cohesion: 0.07
Nodes (52): TypeMarshalError, _coerce_date(), _coerce_decimal(), _coerce_int(), _coerce_objectid(), _coerce_objectid_best_effort(), _marshal_field_value(), marshal_filter() (+44 more)
...
Cohesion: 0.30
Nodes (18): build(), _patch_mongo_factory(), _pipeline_with_registry(), Multi-backend CONNECTION lifecycle / use-case coverage.  These tests exercise EV, Replace MongoClient (used by build()'s _mongo_client_factory) with a     mongomo, _read_audit(), _settings(), test_contextvar_isolation_between_contexts() (+10 more)
...
Cohesion: 0.14
Nodes (19): CostEstimate, Normalized, backend-neutral cost estimate.      FROZEN public contract: this is, _estimate_cost(), guardmcp_plan — dry-run preview of authorization/risk/affected docs + cost., Best-effort normalized cost estimate for an operation. NEVER raises:     returns, register(), _execution_stats(), normalize_mongo_explain() (+11 more)

### Community 110 - "Community 110"
Cohesion: 0.11
Nodes (8): ABC, DatabasePlugin, Public, capability-based contract for a database backend plugin., Return {name, api_version, supported, dialect_features} from class         attrs, Begin a transaction and return its tx_id, or None if unsupported., Commit the transaction identified by tx_id. No-op by default., Roll back the transaction identified by tx_id. No-op by default., CapabilityRequest

### Community 111 - "Community 111"
Cohesion: 0.60
Nodes (5): _make_policy(), pipeline_with(), S-3: field allow-list enforced end-to-end through GuardPipeline.run (FIND)., test_field_allow_drops_disallowed_fields(), test_field_allow_with_masking()
...
Cohesion: 0.29
Nodes (7): build_approval_app(), DecisionPayload, Build the approval REST API.      When api_token is set, all requests must inclu, FastAPI, ReadinessProbe, ApprovalStore, test_health_endpoints_need_no_auth()
...
Cohesion: 0.10
Nodes (21): GuardMCP meta tools (single-named, no db_/mongodb_ alias).  The former monolithi, Register all meta tools onto ``mcp``., register(), guardmcp_setup — interactive policy setup wizard (survey + YAML writer)., register(), guardmcp_status — connection status, statistics, version, policy summary., register(), Any (+13 more)
...
Cohesion: 0.21
Nodes (12): BaseSettings, Settings, AppContext, Start the GuardMCP server (the original entry-point behavior).      This is the, _run_with_approval_api(), serve_main(), Settings, FastMCP (+4 more)

### Community 125 - "Community 125"
Cohesion: 0.42
Nodes (13): _base(), _call(), _client(), _pipeline(), Tests for guardmcp_explain_policy (Feature 2). Drives the REAL tool through a Fa, A merged (inherited) policy is what gets evaluated; trace reflects it., test_explain_allowed(), test_explain_approval_required() (+5 more)
...
Cohesion: 0.24
Nodes (5): ApprovalRequest, Deny all pending approvals immediately and signal their events.         Call on, ApprovalRequest, Any, RiskLevel

### Community 131 - "Community 131"
Cohesion: 0.31
Nodes (4): PolicyLoader, Tests for the evolved (non-flat) policy model: apiVersion, role inheritance (ext, TestExtends, _write()
...
Cohesion: 0.36
Nodes (9): _client(), Tests for the approval API health endpoints (k8s liveness/readiness).  ``/health, test_health_alias_ok(), test_healthz_ok(), test_ready_alias_reflects_probe(), test_readyz_no_probe_is_ready(), test_readyz_probe_not_ready_returns_503_with_detail(), test_readyz_probe_ready() (+1 more)
...
Cohesion: 0.28
Nodes (7): _merge(), _merge_mask_fields(), Order-preserving union of two string lists (base first, child appended)., Merge mask_fields. If either is a dict, merge per-collection (union per     key), Merge `base` under `child` (child overrides). Scalars: child wins when set     t, _union(), Policy
...
Cohesion: 0.33
Nodes (5): ApprovalStoreProtocol, AuditSinkProtocol, PolicyEngine, RiskEngine, PolicyLoader

### Community 139 - "Community 139"
Cohesion: 0.33
Nodes (5): _coerce_none_sentinels(), _parse_json_or_pass(), Database-agnostic grounding/security helpers.  MongoDB-specific validation (oper, Coerce a JSON-encoded string to dict/list. Non-strings pass through., Map '', 'null', 'none', 'undefined' → None for optional dict params.
...
- **Why does `MongoExecutor` connect `Community 15` to `Community 67`, `Community 68`, `Community 40`, `Community 9`, `Community 105`, `Community 43`, `Community 42`, `Community 107`, `Community 41`, `Community 47`, `Community 49`, `Community 18`, `Community 20`, `Community 26`, `Community 29`, `Community 63`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `AuditLogger` connect `Community 21` to `Community 64`, `Community 0`, `Community 131`, `Community 37`, `Community 134`, `Community 6`, `Community 40`, `Community 9`, `Community 105`, `Community 43`, `Community 10`, `Community 7`, `Community 46`, `Community 47`, `Community 56`, `Community 26`, `Community 28`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `GuardPipeline` connect `Community 43` to `Community 0`, `Community 1`, `Community 131`, `Community 4`, `Community 56`, `Community 6`, `Community 40`, `Community 9`, `Community 138`, `Community 105`, `Community 142`, `Community 47`, `Community 24`, `Community 26`?**
